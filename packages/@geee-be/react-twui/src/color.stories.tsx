...
export const Buttons: Story = {
  render: () => <div className="p-8 min-h-screen">
    <div className="grid grid-cols-8 gap-4">
      ...
      <button type="button" className="like-outline-button" data-active={true}>
        Active
      </button>
      ...
      <button type="button" className="col-1 like-outline-button default-primary">
        Primary
      </button>
      ...
      <Button color="primary" className='col-1'>Primary</Button>
      ...
      <Button variant='outline' color="primary" className='col-1'>Primary</Button>
...
export const Inputs: Story = {
  render: () => <div className="p-8 min-h-screen">
    <div className="grid grid-cols-6 gap-4">
      ...
      <input className="like-input" placeholder="Test" disabled value="With a value" />
    </div>
  </div>
};
